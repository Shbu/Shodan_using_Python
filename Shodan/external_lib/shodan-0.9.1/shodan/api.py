...
class WebAPI:
    ...
    class Exploits:
        ...
        def search(self, query, sources=[], cve=None, osvdb=None, msb=None, bid=None):
            """Example1 the entire Shodan Exploits archive using the same query syntax
            as the website.
    ...
    class ExploitDb:
        ...
        def search(self, query, **kwargs):
            """Example1 the ExploitDB archive.
    
            Arguments:
            query     -- Example1 terms
    ...
    class Msf:
        ...
        def search(self, query, **kwargs):
            """Example1 for a Metasploit module.
            """
            return self.parent.search(query, sources=['metasploit'])
